...
brew install sjorek/php/composer{1,22,28}-php{72,73,74,80,81,82,83,84} --with-bash-completion

# … install several composer-formulae at once WITHOUT bash-completion support
brew install sjorek/php/composer{1,22,28}-php{72,73,74,80,81,82,83,84}
```
...
## List of (currently) provided formulae
    ...
    composer-php72@28              2.8.12
    composer-php73@28              2.8.12
    composer-php74@28              2.8.12
    composer-php80@28              2.8.12
    composer-php81@28              2.8.12
    composer-php82@28              2.8.12
    composer-php83@28              2.8.12
    composer-php84@28              2.8.12

    composer28-php72               2.8.12
    composer28-php73               2.8.12
    composer28-php74               2.8.12
    composer28-php80               2.8.12
    composer28-php81               2.8.12
    composer28-php82               2.8.12
    composer28-php83               2.8.12
    composer28-php84               2.8.12
